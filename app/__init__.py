...
app.config["SECRET_KEY"] = os.getenv("SECRET_KEY", "2004")
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv("DB_URI", "sqlite:///test.db")
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
app.config['MAIL_USERNAME'] = os.getenv("EMAIL", "demo2gmail.com.com")
app.config['MAIL_PASSWORD'] = os.getenv("PASSWORD", "12345678")
